<?php
  ...
  switch($action){
    case 'Submit MadLib':
      $plural_noun_one = mysqli_real_escape_string($con, $_POST['plural_noun_one']);
      $plural_noun_two = mysqli_real_escape_string($con, $_POST['plural_noun_two']);
      $adjective_one = mysqli_real_escape_string($con, $_POST['adjective_one']);
      $noun_one = mysqli_real_escape_string($con, $_POST['noun_one']);
      $adjective_two = mysqli_real_escape_string($con, $_POST['adjective_two']);
      $adjective_three =  mysqli_real_escape_string($con, $_POST['adjective_three']);
      $verb =  mysqli_real_escape_string($con, $_POST['verb']);
      $body_part =  mysqli_real_escape_string($con, $_POST['body_part']);
      $adjective_four =  mysqli_real_escape_string($con, $_POST['adjective_four']);
      $number =  mysqli_real_escape_string($con, $_POST['number']);
      $noun_two =  mysqli_real_escape_string($con, $_POST['noun_two']);
