<?php
  ...
  switch($action){
    case 'Submit MadLib':
      ...
      if($r) {
        $madLib = "$insertMadLib Jack and his mother were so poor that they only had two old $plural_noun_one. Jack's mother sent him to the
...
function getMadLibID($getNewMadLib){
